...
function startgame(){
  gamestatus="start";
document.getElementById("status").innerHTML="YOUR GAME IS LOADING HIYAA"
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("PRESS THE DUMB BUTTON HAIYAA", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
